...
const theme = extendTheme({
  ...
  colors: {
    ...
    border: {
      active: '#000',
      brand: '#8fead7',
      brandDecorative: 'rgba(143, 234, 215, 0.4)',
      decorative: '#ccc',
  ...
  shadows: {
    brand: {
      drop: '0px 0px 15px rgba(143, 234, 215, 0.3)',
      left: '-4px 0px 15px rgba(143, 234, 215, 0.3)',
      top: '0px -4px 15px rgba(143, 234, 215, 0.3)',
      right: '4px 0px 15px rgba(143, 234, 215, 0.3)',
    },
    primary: {
